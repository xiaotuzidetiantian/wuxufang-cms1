...
//		for (org.jsoup.nodes.Element element : linkList) {
...
//			//post_Text
//			
//			if(href!=null && href.contains("163.com") && href.endsWith(".html")) {
//				Document document2 = Jsoup.connect(href).get();
//				Elements content = document2.select(".post_text");
//				String contentHtml = content.html();
//				if(contentHtml.contains(".post_text")) {
//					System.out.println(href);
//				}
//			}
//		}
